...
function forSession(sessionId) {
  ...
  return {
    ...
    getRouterUsage: () => ipcRenderer.invoke('host:getRouterUsage'),
...
contextBridge.exposeInMainWorld('codex', {
  ...
  setup: {
    ...
    update: id => ipcRenderer.invoke('setup:update', id),
    ...
    startPortalConfig: () => ipcRenderer.invoke('setup:startPortalConfig'),
    pollPortalConfig: flowId => ipcRenderer.invoke('setup:pollPortalConfig', flowId),
    openPortalVerification: flowId => ipcRenderer.invoke('setup:openPortalVerification', flowId),
    cancelPortalConfig: flowId => ipcRenderer.invoke('setup:cancelPortalConfig', flowId),
    applyPortalConfig: options => ipcRenderer.invoke('setup:applyPortalConfig', options),
